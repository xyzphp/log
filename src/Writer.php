...
class Writer implements LogContract, PsrLoggerInterface
{
    ...
    {
        $this->fireLogEvent(__FUNCTION__, $message = $this->formatMessage($message), $context);
    }
    ...
    {
        return new LineFormatter($this->getLineFormatter(), null, true, true);
    }
     ...
     * @return string
     */
    public function getLineFormatter($format = null)
    {
        return $format ?: "%datetime% %channel% %level_name% %message% %context% %extra%\n";
    }
